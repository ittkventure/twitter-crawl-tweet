...
{
    public class AirTableManualSourceProcessWaitingWorker : ITransientDependency
    {
        ...
        public AirTableManualSourceProcessWaitingWorker(
        ...
        public async Task DoWorkAsync()
        {
            ...
            try
            {
                await _backgroundJobManager.EnqueueAsync(new AirTableManualSourceProcessWaitingJobArg());
