...
[DependsOn(typeof(AbpDapperModule))]
    public class CrawlEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<CrawlDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also CrawlMigrationsDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
