...
public class CrawlHttpApiHostModule : AbpModule
{
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        RecurringJob.RemoveIfExists(nameof(CoinGeckoProcessWaitingWorker));
        if (config.GetValue<bool>("RecurringJobs:CoinGeckoProcessWaitingWorker:Enable"))
        {
            RecurringJob.AddOrUpdate<CoinGeckoProcessWaitingWorker>(nameof(CoinGeckoProcessWaitingWorker), t => t.DoWorkAsync(), config.GetValue<string>("RecurringJobs:CoinGeckoProcessWaitingWorker:CronExpression"));
        }

        RecurringJob.RemoveIfExists(nameof(CoinGeckoSyncNewCoinWorker));
        if (config.GetValue<bool>("RecurringJobs:CoinGeckoSyncNewCoinWorker:Enable"))
        {
        ...
        RecurringJob.RemoveIfExists(nameof(AirTableNoMentionPullDataWorker));
        if (config.GetValue<bool>("RecurringJobs:AirTableNoMentionPullDataWorker:Enable"))
        {
        ...
        RecurringJob.RemoveIfExists(nameof(GoogleNewsPullingCryptoCurrencyTopicWorker));
        if (config.GetValue<bool>("RecurringJobs:GoogleNewsPullingCryptoCurrencyTopicWorker:Enable"))
        {
            RecurringJob.AddOrUpdate<GoogleNewsPullingCryptoCurrencyTopicWorker>(nameof(GoogleNewsPullingCryptoCurrencyTopicWorker), t => t.DoWorkAsync(), config.GetValue<string>("RecurringJobs:GoogleNewsPullingCryptoCurrencyTopicWorker:CronExpression"));
        }
